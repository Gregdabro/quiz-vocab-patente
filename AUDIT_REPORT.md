...
**5.2 Auto-advance после ответа** — ❌ REVERTED 2026-05-16
- Причина: авто-переход не давал пользователю времени прочитать комментарий и усвоить ошибку. Пользователь сам решает когда перейти к следующему вопросу через пагинацию.
- Файл: `src/hooks/useQuiz.js` (коммит `3bfd8d9`)
